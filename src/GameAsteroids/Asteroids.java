...
public class Asteroids extends MovingSpaceObjects implements Collider,Movable,Drawable
{
...
{
myRNG=new Random();
int x5=myRNG.nextInt(3000); //sets Random Locations
...
x=myRNG.nextInt(359); //heading
if(x==0)
x=1;
setHeading(x);
x=myRNG.nextInt(200); //speed
if(x<1)
x=1;
setSpeed(x);
...
int ty=myRNG.nextInt(40); //random base of asteroid
if(ty<15)
ty=15;
base=ty;

ty=myRNG.nextInt(40); //random height of asteroid
if(ty<15)
ty=15;
height=ty;
